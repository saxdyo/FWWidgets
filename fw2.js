// 在文件顶部添加配置
const VERCEL_OG_SERVICE = "https://fw-widgets-pdb6ftlwx-sams-projects-20fafaa5.vercel.app"; // 您的原始Vercel链接
...
async function loadTmdbTrendingFromPreprocessed(params = {}) {
  ...
  try {
    ...
    const localBackdrops = {
      "50821": "50821_Bartok kzt.jpg",
      "65270": "65270_黄金渔场之明星电台.jpg",
      "65733": "65733_哆啦A梦.jpg",
      "70672": "70672_认识的哥哥.jpg",
      "112470": "112470_一切从这里开始.jpg",
      "196890": "196890_战酋.jpg",
      "241388": "241388_瓦坎达之眼.jpg",
      "244808": "244808_拔作岛.jpg",
      "552524": "552524_星际宝贝史迪奇.jpg",
      "617126": "617126_神奇4侠初露锋芒.jpg",
      "755898": "755898_世界大战.jpg",
      "980477": "980477_哪吒之魔童闹海.jpg",
      "986206": "986206_Night Carnage.jpg",
      "1035259": "1035259_新白头神探.jpg",
      "1087192": "1087192_新驯龙高手.jpg",
      "1100988": "1100988_惊变28年.jpg",
      "1263256": "1263256_高尔夫球也疯狂2.jpg",
      "1307078": "1307078_爱在牛津的一年.jpg",
    ...
    const widgetItems = await Promise.all(results.map(async (item) => {
      ...
      const widgetItem = {
        ...
        // 优先使用本地生成的带标题背景图
        localBackdropUrl: getLocalBackdropUrl(item.id),
        backdropPath: getLocalBackdropUrl(item.id) || imageUrls.backdropPath,
        backdropUrls: getLocalBackdropUrl(item.id) ? [getLocalBackdropUrl(item.id)] : imageUrls.backdropUrls,
        title_backdrop: getLocalBackdropUrl(item.id) || item.title_backdrop,
        rating: item.rating,

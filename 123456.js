...
async function loadTmdbByTheme(params = {}) {
  ...
  try {
    ...
    // 使用标准格式返回，与 createWidgetItemWithoutCDN 完全一致
    const widgetItems = allResults.map(item => {
      ...
      return {
        ...
        type: "tmdb",
        title: item.title || item.name || "未知标题",
        genreTitle: getGenreTitle(item.genre_ids, mediaType),
        rating: item.vote_average || 0,
        description: item.overview || "",
        releaseDate: releaseDate || "",
    ...
    action: [
      {
        ...
        release_date: "1999-10-15", popularity: 100, vote_count: 1000
      },
      {
        ...
        release_date: "2001-12-19", popularity: 100, vote_count: 1000
      }
    ],
    sci_fi: [
      {
        ...
        release_date: "1977-05-25", popularity: 100, vote_count: 1000
      }
    ],
    comedy: [
      {
        ...
        first_air_date: "2007-09-24", popularity: 100, vote_count: 1000
      }
    ]
  };
